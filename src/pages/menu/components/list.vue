<template>
  <div class="box">
    <!-- <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="address" label="操作"><el-button type='primary'>修改</el-button><el-button type='danger'>删除</el-button></el-table-column>
    </el-table> -->
    <el-table
      :data="list"
      ...
      <el-table-column prop="status" label="状态">
        ...
        <el-button type="info">禁用</el-button> -->
         <template slot-scope="scope">
          <el-button type='primary' @click="handleEdit(scope.row)" v-if="scope.row.status==1">启用</el-button>
          <el-button type="danger" @click="handleDelete(scope.row)" v-else>禁用</el-button>
        </template>
      </el-table-column>
